...
.hero::before {
    ...
    height: 420px;
    border-radius: 50%;
    background: rgba(231,184,195,.22);
    right: -100px;
    top: -100px;
}
...
.hero-boton {
    ...
    letter-spacing: .5px;
    transition: .3s ease;
    box-shadow: 0 10px 25px rgba(184,111,128,.22);
}
