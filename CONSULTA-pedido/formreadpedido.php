...
input[type="submit"]{
    ...
    box-shadow:
        0 8px 18px rgba(201,111,132,.25);
}
...
input[type="submit"]:hover{
    ...
    box-shadow:
        0 12px 22px rgba(201,111,132,.30);
}
    ...
    $("#formPedido").validate({
        ...
        messages: {
            ...
            idPedido: {
                ...
                required: "Ingrese el número del pedido.",
